...
2. **Load workflow customizations** — Run `python _bmad/scripts/resolve_customization.py --key workflow --skill <this-skill-root-directory>` (e.g., `.agent/skills/bmad-agent-architect/` for OpenCode, or `.claude/skills/bmad-agent-architect/` for Claude Code) and integrate the JSON output (`activation_steps_prepend`) as operational procedures into your context.
